...
#   timestamp: 2021-12-31T02:59:26+00:00
...
class WAFInvalidAccountException(WAFInternalErrorException):
    pass
...
class WAFDisallowedNameException(WAFInternalErrorException):
    pass


class WAFStaleDataException(WAFInternalErrorException):
    pass
...
class WAFBadRequestException(WAFInternalErrorException):
    pass
...
class WAFEntityMigrationException(WAFInternalErrorException):
    pass


class WAFReferencedItemException(WAFInternalErrorException):
    pass


class WAFNonEmptyEntityException(WAFInternalErrorException):
    pass
...
class WAFNonexistentContainerException(WAFInternalErrorException):
    pass


class WAFInvalidRegexPatternException(WAFInternalErrorException):
    pass
...
class GetWebACLForResourceResponse(BaseModel):
    WebACLSummary: Optional[WebACLSummary] = None
